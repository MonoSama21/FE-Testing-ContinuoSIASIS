@WeekendTest
Feature: Indisponibilidad del rol Profesor de Primaria para registrar asistencia en día no laborable
...
@Escenario09
Scenario: Validar que no se puede registrar la asistencia del rol Profesor de Primaria un día no laborable
